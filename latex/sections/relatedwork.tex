...
based on game theory. A typical GAN optimization scheme consists of
simultaneously training a generator network to produce realistic fake samples 
and a discriminator network to distinguish between real and fake data. 
...
Different approach was used in \cite{chen2018} to construct double 
...
set of images of persons sharing the same expression \cite{pumarola2018}. Our
